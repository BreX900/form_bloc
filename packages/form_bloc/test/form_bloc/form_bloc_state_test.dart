...
void main() {
  group('FormBlocState:', () {
    test('Equality', () {
      final state1 = FormBlocLoaded<String, String>(
        isValidByStep: {1: true, 2: false},
      );
      final state2 = FormBlocLoaded<String, String>(isValidByStep: {1: true});

      final state3 = FormBlocLoaded<String, String>(
        isValidByStep: {1: true, 2: false},
      );
    ...
    test('to methods', () {
      ...
      final deleteFailed = submissionCancelled.toDeleteFailed(
        failureResponse: 'fail',
      );
      final deleteSuccessful = deleteFailed.toDeleteSuccessful(
    ...
    group('hasSuccessResponse property:', () {
      test('FormBlocSuccess', () {
        ...
        final successWithoutResponse = FormBlocSuccess<Object, Object>(
          isValidByStep: {},
        );
    ...
    group('hasFailureResponse property:', () {
      test('FormBlocLoadFailed', () {
        ...
        final loadedFailedWithoutResponse = FormBlocLoadFailed<Object, Object>(
          isValidByStep: {},
        );
      ...
      test('FormBlocFailure', () {
        ...
        final failureWithoutResponse = FormBlocFailure<Object, Object>(
          isValidByStep: {},
        );
