...
typedef FormBlocListenerCallback<
  TFormBlocState extends FormBlocState<SuccessResponse, ErrorResponse>,
  SuccessResponse,
  ErrorResponse
> = void Function(BuildContext context, TFormBlocState state);

/// [BlocListener] that reacts to the state changes of the FormBloc.
class FormBlocListener<
  TFormBloc extends FormBloc<SuccessResponse, ErrorResponse>,
  SuccessResponse,
  ErrorResponse
>
    extends
        BlocListener<TFormBloc, FormBlocState<SuccessResponse, ErrorResponse>> {
  /// [BlocListener] that reacts to the state changes of the FormBloc.
  /// {@macro bloclistener}
  FormBlocListener({
    Key? key,
         ...
         listener: (context, state) {
           if (state is FormBlocLoading<SuccessResponse, ErrorResponse> &&
             ...
             onSubmitting(context, state);
                   ...
                   is FormBlocSuccess<SuccessResponse, ErrorResponse> &&
               onSuccess != null) {
             ...
             onFailure(context, state);
                   ...
                   is FormBlocSubmissionCancelled<
                     SuccessResponse,
                     ErrorResponse
                   > &&
